 ...
 * limitations under the License.
 */
class gr{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const mr="@firebase/app",vr="0.9.7",_r=new Ji("@firebase/app"),yr="[DEFAULT]",wr={[mr]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},br=new Map,Er=new Map;function Tr(e,t){try{e.container.addComponent(t)}catch(n){_r.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Sr(e){const t=e.name;if(Er.has(t))return _r.debug(`There were multiple attempts to register component ${t}.`),!1;Er.set(t,e);for(const t of br.values())Tr(t,e);return!0}function Ir(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var qr;qr="",Sr(new Bi("platform-logger",(e=>new gr(e)),"PRIVATE")),Sr(new Bi("heartbeat",(e=>new Br(e)),"PRIVATE")),Or(mr,vr,qr),Or(mr,vr,"esm2017"),Or("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function So(e,t,n=!1){const i="signIn",r=await bo(e,i,t),s=await _o._fromIdTokenResponse(e,i,r);return n||await e._updateCurrentUser(s.user),s}async function Io(e,t){return So(Js(e),t)}async function Co(e,t,n){const i=Js(e),r=await vo(i,{returnSecureToken:!0,email:t,password:n}),s=await _o._fromIdTokenResponse(i,"signIn",r);return await i._updateCurrentUser(s.user),s}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{sg(i,new Xp(t.toString()+"/"+e),n)}))}class og{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&_p(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Gd=Rr,Sr(new Bi("database",((e,{instanceIdentifier:t})=>Rv(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),Or(Vd,Wd,e),Or(Vd,Wd,"esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const Nv=document.querySelector(".auth__backdrop"),Ov=document.querySelector(".auth__form"),Pv=(document.querySelector(".auth__unputs"),document.querySelector(".auth__button__close")),Lv=document.querySelector("#user_name"),xv=document.querySelector("#user_email"),Dv=document.querySelector("#user_password"),Mv=document.querySelector("#btnLogin"),Uv=document.querySelector("#btnSignup"),Fv=document.querySelector("#btnLogout"),Bv=document.querySelector(".link__signup"),jv=document.querySelector(".link__signin"),Hv=document.querySelector(".message__login"),zv=document.querySelector(".users-login"),qv=document.querySelector(".users-data--tablet").lastElementChild;console.log(zv.textContent);const Vv=function(e=Nr()){const t=Ir(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Ir(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Ci(n.getOptions(),null!=t?t:{}))return e;Xr(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Ba,persistence:[Ko,Oo,Lo]}),i=si("authTokenSyncURL");if(i){const e=(r=i,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>qa)return;const i=null==t?void 0:t.token;Va!==i&&(Va=i,await fetch(r,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){Fi(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,i){Fi(e).onIdTokenChanged(t,n,i)}(n,(t=>e(t)))}var r;const s=ii("auth");return s&&Qs(n,`http://${s}`),n}(Ar({appName:"BookProject",apiKey:"AIzaSyCeohKwpW6233js3UPE5dhzJtQnOMgZfaI",authDomain:"itsharks-books-project.firebaseapp.com",databaseURL:"https://itsharks-books-project-default-rtdb.firebaseio.com",projectId:"itsharks-books-project",storageBucket:"itsharks-books-project.appspot.com",messagingSenderId:"560994919300",appId:"1:560994919300:web:10cdf4110616a9d01f33d1"}));const Wv=e=>{e.code==Kr.INVALID_PASSWORD?alert("Wrong password. Try again."):alert(`Error: ${e.message}`)},Gv=e=>{Hv.insertAdjacentHTML("beforeend",`<p class="auth__true__notify">You're logged in as <span>${e.email}<span></p>`),Ov.style.display="none",Fv.style.display="block"};jv.addEventListener("click",(()=>{Mv.style.display="",Uv.style.display="none",Bv.style.display="",jv.style.display="none",Lv.style.display="none",Hv.innerHTML="",Hv.insertAdjacentHTML("beforeend",'<p class="auth__false__notify">You\'re not logged in</p>')})),Bv.addEventListener("click",(()=>{Mv.remove(),Uv.style.display="block",Bv.style.display="none",jv.style.display="block",Lv.style.display="block",Hv.innerHTML="",Hv.insertAdjacentHTML("beforeend",'<p class="auth__notify">You can SIGN UP on this website</p>')}));Uv.addEventListener("click",(async e=>{e.preventDefault();const t=Lv.value.trim(),n=xv.value.trim(),i=Dv.value.trim();Lv.style.display="block";try{await Co(Vv,n,i).then((()=>{ko(Vv.currentUser,{displayName:t})})),location.reload()}catch{}}));const $v=()=>{Ov.style.display="block",Fv.style.display="none",Lv.style.display="none",xv.value="",Dv.value=""};Mv.addEventListener("click",(async e=>{e.preventDefault();const t=xv.value.trim(),n=Dv.value.trim();console.log(t);try{await(i=Vv,r=t,s=n,Io(Fi(i),co.credential(r,s)))}catch(e){console.log(`There was an error: ${e}`),Wv(e)}var i,r,s;
/**
 * @license
 * Copyright 2020 Google LLC
 *
