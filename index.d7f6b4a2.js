 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class q extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const B=function(e){const t=j(e);return H.encodeByteArray(t,!0)},V=function(e){return B(e).replace(/\./g,"")},W=function(e){try{return H.decodeString(e,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function we(e){const t=[];for(const[n,i]of Object.entries(e))Array.isArray(i)?i.forEach((e=>{t.push(encodeURIComponent(n)+"="+encodeURIComponent(e))})):t.push(encodeURIComponent(n)+"="+encodeURIComponent(i));return t.length?"&"+t.join("&"):""}function Ie(e){const t={};return e.replace(/^\?/,"").split("&").forEach((e=>{if(e){const[n,i]=e.split("=");t[decodeURIComponent(n)]=decodeURIComponent(i)}})),t}function be(e){const t=e.indexOf("?");if(!t)return"";const n=e.indexOf("#",t);return e.substring(t,n>0?n:void 0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xe=[];var Me,Ue;(Ue=Me||(Me={}))[Ue.DEBUG=0]="DEBUG",Ue[Ue.VERBOSE=1]="VERBOSE",Ue[Ue.INFO=2]="INFO",Ue[Ue.WARN=3]="WARN",Ue[Ue.ERROR=4]="ERROR",Ue[Ue.SILENT=5]="SILENT";const Fe={debug:Me.DEBUG,verbose:Me.VERBOSE,info:Me.INFO,warn:Me.WARN,error:Me.ERROR,silent:Me.SILENT},je=Me.INFO,He={[Me.DEBUG]:"log",[Me.VERBOSE]:"log",[Me.INFO]:"info",[Me.WARN]:"warn",[Me.ERROR]:"error"},qe=(e,t,...n)=>{if(t<e.logLevel)return;const i=(new Date).toISOString(),s=He[t];if(!s)throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`);console[s](`[${i}]  ${e.name}:`,...n)};class Be{constructor(e){this.name=e,this._logLevel=je,this._logHandler=qe,this._userLogHandler=null,xe.push(this)}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in Me))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel="string"==typeof e?Fe[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,Me.DEBUG,...e),this._logHandler(this,Me.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,Me.VERBOSE,...e),this._logHandler(this,Me.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,Me.INFO,...e),this._logHandler(this,Me.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,Me.WARN,...e),this._logHandler(this,Me.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,Me.ERROR,...e),this._logHandler(this,Me.ERROR,...e)}}const Ve=(e,t)=>t.some((t=>e instanceof t));let We,ze;const $e=new WeakMap,Ke=new WeakMap,Ge=new WeakMap,Ye=new WeakMap,Xe=new WeakMap;let Je={get(e,t,n){if(e instanceof IDBTransaction){if("done"===t)return Ke.get(e);if("objectStoreNames"===t)return e.objectStoreNames||Ge.get(e);if("store"===t)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return et(e[t])},set:(e,t,n)=>(e[t]=n,!0),has:(e,t)=>e instanceof IDBTransaction&&("done"===t||"store"===t)||t in e};function Qe(e){return e!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?(ze||(ze=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])).includes(e)?function(...t){return e.apply(tt(this),t),et($e.get(this))}:function(...t){return et(e.apply(tt(this),t))}:function(t,...n){const i=e.call(tt(this),t,...n);return Ge.set(i,t.sort?t.sort():[t]),et(i)}}function Ze(e){return"function"==typeof e?Qe(e):(e instanceof IDBTransaction&&function(e){if(Ke.has(e))return;const t=new Promise(((t,n)=>{const i=()=>{e.removeEventListener("complete",s),e.removeEventListener("error",r),e.removeEventListener("abort",r)},s=()=>{t(),i()},r=()=>{n(e.error||new DOMException("AbortError","AbortError")),i()};e.addEventListener("complete",s),e.addEventListener("error",r),e.addEventListener("abort",r)}));Ke.set(e,t)}(e),Ve(e,We||(We=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction]))?new Proxy(e,Je):e)}function et(e){if(e instanceof IDBRequest)return function(e){const t=new Promise(((t,n)=>{const i=()=>{e.removeEventListener("success",s),e.removeEventListener("error",r)},s=()=>{t(et(e.result)),i()},r=()=>{n(e.error),i()};e.addEventListener("success",s),e.addEventListener("error",r)}));return t.then((t=>{t instanceof IDBCursor&&$e.set(t,e)})).catch((()=>{})),Xe.set(t,e),t}(e);if(Ye.has(e))return Ye.get(e);const t=Ze(e);return t!==e&&(Ye.set(e,t),Xe.set(t,e)),t}const tt=e=>Xe.get(e);function nt(e,t,{blocked:n,upgrade:i,blocking:s,terminated:r}={}){const o=indexedDB.open(e,t),a=et(o);return i&&o.addEventListener("upgradeneeded",(e=>{i(et(o.result),e.oldVersion,e.newVersion,et(o.transaction))})),n&&o.addEventListener("blocked",(()=>n())),a.then((e=>{r&&e.addEventListener("close",(()=>r())),s&&e.addEventListener("versionchange",(()=>s()))})).catch((()=>{})),a}const it=["get","getKey","getAll","getAllKeys","count"],st=["put","add","delete","clear"],rt=new Map;function ot(e,t){if(!(e instanceof IDBDatabase)||t in e||"string"!=typeof t)return;if(rt.get(t))return rt.get(t);const n=t.replace(/FromIndex$/,""),i=t!==n,s=st.includes(n);if(!(n in(i?IDBIndex:IDBObjectStore).prototype)||!s&&!it.includes(n))return;const r=async function(e,...t){const r=this.transaction(e,s?"readwrite":"readonly");let o=r.store;return i&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),s&&r.done]))[0]};return rt.set(t,r),r}Je=(e=>({...e,get:(t,n,i)=>ot(t,n)||e.get(t,n,i),has:(t,n)=>!!ot(t,n)||e.has(t,n)}))(Je);
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wt="9.19.1";function It(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const i=Object.assign({name:ut,automaticDataCollectionEnabled:!1},t),s=i.name;if("string"!=typeof s||!s)throw yt.create("bad-app-name",{appName:String(s)});if(n||(n=X()),!n)throw yt.create("no-options");const r=pt.get(s);if(r){if(ye(n,r.options)&&ye(i,r.config))return r;throw yt.create("duplicate-app",{appName:s})}const o=new Le(s);for(const e of ft.values())o.addComponent(e);const a=new vt(n,i,o);return pt.set(s,a),a}function bt(e=ut){const t=pt.get(e);if(!t&&e===ut)return It();if(!t)throw yt.create("no-app",{appName:e});return t}function Et(e,t,n){var i;let s=null!==(i=dt[e])&&void 0!==i?i:e;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=t.match(/\s|\//);if(r||o){const e=[`Unable to register library "${s}" with version "${t}":`];return r&&e.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void ct.warn(e.join(" "))}mt(new Oe(`${s}-version`,(()=>({library:s,version:t})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vt(e,...t){throw $t(e,...t)}function Wt(e,...t){return $t(e,...t)}function zt(e,t,n){const i=Object.assign(Object.assign({},Ft()),{[t]:n});return new ae("auth","Firebase",i).create(t,{appName:e.name})}function $t(e,...t){if("string"!=typeof e){const n=t[0],i=[...t.slice(1)];return i[0]&&(i[0].appName=e.name),e._errorFactory.create(n,...i)}return jt.create(e,...t)}function Kt(e,t,...n){if(!e)throw $t(t,...n)}function Gt(e){const t="INTERNAL ASSERTION FAILED: "+e;throw Bt(t),new Error(t)}function Yt(e,t){e||Gt(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class bn{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){Kt(e.idToken,"internal-error"),Kt(void 0!==e.idToken,"internal-error"),Kt(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=_n(e);return Kt(t,"internal-error"),Kt(void 0!==t.exp,"internal-error"),Kt(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return Kt(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:s}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nn(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Dn(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(An(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(xn(t))return"Blackberry";if(Mn(t))return"Webos";if(On(t))return"Safari";if((t.includes("chrome/")||Pn(t))&&!t.includes("edge/"))return"Chrome";if(Ln(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function An(e=Z()){return/firefox\//i.test(e)}function On(e=Z()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Pn(e=Z()){return/crios\//i.test(e)}function Dn(e=Z()){return/iemobile/i.test(e)}function Ln(e=Z()){return/android/i.test(e)}function xn(e=Z()){return/blackberry/i.test(e)}function Mn(e=Z()){return/webos/i.test(e)}function Un(e=Z()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Fn(){return ie()&&10===document.documentMode}function jn(e=Z()){return Un(e)||Ln(e)||Mn(e)||xn(e)||/windows phone/i.test(e)||Dn(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */()}function $n(e){const t=e.indexOf(":");return t<0?"":e.substr(0,t+1)}function Kn(e){if(!e)return null;const t=Number(e);return isNaN(t)?null:t}class Gn{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return Gt("not implemented")}_getIdTokenResponse(e){return Gt("not implemented")}_linkToIdToken(e,t){return Gt("not implemented")}_getReauthenticationResolver(e){return Gt("not implemented")}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jn(e,t){return un(e,"POST","/v1/accounts:signInWithIdp",hn(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ti{constructor(e){var t,n,i,s,r,o;const a=Ie(be(e)),h=null!==(t=a.apiKey)&&void 0!==t?t:null,l=null!==(n=a.oobCode)&&void 0!==n?n:null,c=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(i=a.mode)&&void 0!==i?i:null);Kt(h&&l&&c,"argument-error"),this.apiKey=h,this.operation=c,this.code=l,this.continueUrl=null!==(s=a.continueUrl)&&void 0!==s?s:null,this.languageCode=null!==(r=a.languageCode)&&void 0!==r?r:null,this.tenantId=null!==(o=a.tenantId)&&void 0!==o?o:null}static parseLink(e){const t=function(e){const t=Ie(be(e)).link,n=t?Ie(be(t)).deep_link_id:null,i=Ie(be(e)).deep_link_id;return(i?Ie(be(i)).link:null)||i||n||t||e}(e);try{return new ti(t)}catch(e){return null}}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class ni{constructor(){this.providerId=ni.PROVIDER_ID}static credential(e,t){return Xn._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=ti.parseLink(t);return Kt(n,"argument-error"),Xn._fromEmailAndCode(e,n.code,n.tenantId)}}ni.PROVIDER_ID="password",ni.EMAIL_PASSWORD_SIGN_IN_METHOD="password",ni.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ii{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(wi,"1"),this.storage.removeItem(wi),Promise.resolve(!0)):Promise.resolve(!1)}catch(e){return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ti extends Ii{constructor(){super((()=>window.sessionStorage),"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Ti.type="SESSION";const Ci=Ti;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Vi="recaptcha";async function Wi(e,t,n){var i;const s=await n.verify();try{let r;if(Kt("string"==typeof s,e,"argument-error"),Kt(n.type===Vi,e,"argument-error"),r="string"==typeof t?{phoneNumber:t}:t,"session"in r){const t=r.session;if("phoneNumber"in r){Kt("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e,t){return ln(e,"POST","/v2/accounts/mfaEnrollment:start",hn(e,t))}(e,{idToken:t.credential,phoneEnrollmentInfo:{phoneNumber:r.phoneNumber,recaptchaToken:s}});return n.phoneSessionInfo.sessionInfo}{Kt("signin"===t.type,e,"internal-error");const n=(null===(i=r.multiFactorHint)||void 0===i?void 0:i.uid)||r.multiFactorUid;Kt(n,e,"missing-multi-factor-info");const o=await function(e,t){return ln(e,"POST","/v2/accounts/mfaSignIn:start",hn(e,t))}(e,{mfaPendingCredential:t.credential,mfaEnrollmentId:n,phoneSignInInfo:{recaptchaToken:s}});return o.phoneResponseInfo.sessionInfo}}{const{sessionInfo:t}=await async function(e,t){return ln(e,"POST","/v1/accounts:sendVerificationCode",hn(e,t))}(e,{phoneNumber:r.phoneNumber,recaptchaToken:s});return t}}finally{n._reset()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function $i(e,t){return t?Jt(t):(Kt(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */zi.PROVIDER_ID="phone",zi.PHONE_SIGN_IN_METHOD="phone";class Ki extends Gn{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Jn(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Jn(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Jn(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function Gi(e){return mi(e.auth,new Ki(e),e.bypassAuthState)}function Yi(e){const{auth:t,user:n}=e;return Kt(n,t,"internal-error"),gi(n,new Ki(e),e.bypassAuthState)}async function Xi(e){const{auth:t,user:n}=e;return Kt(n,t,"internal-error"),fi(n,new Ki(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ys=new nn(5e3,15e3),vs="__/auth/iframe",ws="emulator/auth/iframe",Is={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},bs=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Es(e){const t=e.config;Kt(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?sn(t,ws):`https://${e.config.authDomain}/${vs}`,i={apiKey:t.apiKey,appName:e.name,v:wt},s=bs.get(e.config.apiHost);s&&(i.eid=s);const r=e._getFrameworks();return r.length&&(i.fw=r.join(",")),`${n}?${we(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t||"",a),new Cs(null);const u=window.open(t||"",a,c);Kt(u,e,"popup-blocked");try{u.focus()}catch(e){}return new Cs(u)}const Ss="__/auth/handler",Rs="emulator/auth/handler";function Ns(e,t,n,i,s,r){Kt(e.config.authDomain,e,"auth-domain-config-required"),Kt(e.config.apiKey,e,"invalid-api-key");const o={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:i,v:wt,eventId:s};if(t instanceof ii){t.setDefaultLanguage(e.languageCode),o.providerId=t.providerId||"",me(t.getCustomParameters())||(o.customParameters=JSON.stringify(t.getCustomParameters()));for(const[e,t]of Object.entries(r||{}))o[e]=t}if(t instanceof si){const e=t.getScopes().filter((e=>""!==e));e.length>0&&(o.scopes=e.join(","))}e.tenantId&&(o.tid=e.tenantId);const a=o;for(const e of Object.keys(a))void 0===a[e]&&delete a[e];return`${function({config:e}){return e.emulator?sn(e,Rs):`https://${e.authDomain}/${Ss}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${we(a).slice(1)}`}const As="webStorageSupport";const Os=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Ci,this._completeRedirectFn=os,this._overrideRedirectResult=is}async _openPopup(e,t,n,i){var s;Yt(null===(s=this.eventManagers[e._key()])||void 0===s?void 0:s.manager,"_initialize() not called before _openPopup()");return ks(e,Ns(e,t,n,Qt(),i),Si())}async _openRedirect(e,t,n,i){var s;return await this._originValidation(e),s=Ns(e,t,n,Qt(),i),Ni().location.href=s,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(Yt(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await _s(e),n=Ni().gapi;return Kt(n,e,"internal-error"),t.open({where:document.body,url:Es(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Is,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const s=Wt(e,"network-request-failed"),r=Ni().setTimeout((()=>{i(s)}),ys.get());function o(){Ni().clearTimeout(r),n(t)}t.ping(o).then(o,(()=>{i(s)}))}))))}(e),n=new as(e);return t.register("authEvent",(t=>{Kt(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(As,{type:As},(n=>{var i;const s=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i[As];void 0!==s&&t(!!s),Vt(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=ds(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return jn()||On()||Un()}};var Ps="@firebase/auth",Ds="0.22.0";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jh(e="Unexpected state"){const t=`FIRESTORE (${Lh}) INTERNAL ASSERTION FAILED: `+e;throw Uh(t),new Error(t)}function Hh(e,t){e||jh()}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wh{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class zh{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable((()=>t(Dh.UNAUTHENTICATED)))}shutdown(){}}class $h{constructor(e){this.t=e,this.currentUser=Dh.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){let n=this.i;const i=e=>this.i!==n?(n=this.i,t(e)):Promise.resolve();let s=new Vh;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new Vh,e.enqueueRetryable((()=>i(this.currentUser)))};const r=()=>{const t=s;e.enqueueRetryable((async()=>{await t.promise,await i(this.currentUser)}))},o=e=>{Mh("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=e,this.auth.addAuthTokenListener(this.o),r()};this.t.onInit((e=>o(e))),setTimeout((()=>{if(!this.auth){const e=this.t.getImmediate({optional:!0});e?o(e):(Mh("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new Vh)}}),0),r()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then((t=>this.i!==e?(Mh("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):t?(Hh("string"==typeof t.accessToken),new Wh(t.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return Hh(null===e||"string"==typeof e),new Dh(e)}}class Kh{constructor(e,t,n){this.h=e,this.l=t,this.m=n,this.type="FirstParty",this.user=Dh.FIRST_PARTY,this.g=new Map}p(){return this.m?this.m():null}get headers(){this.g.set("X-Goog-AuthUser",this.h);const e=this.p();return e&&this.g.set("Authorization",e),this.l&&this.g.set("X-Goog-Iam-Authorization-Token",this.l),this.g}}class Gh{constructor(e,t,n){this.h=e,this.l=t,this.m=n}getToken(){return Promise.resolve(new Kh(this.h,this.l,this.m))}start(e,t){e.enqueueRetryable((()=>t(Dh.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class Yh{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Xh{constructor(e){this.I=e,this.forceRefresh=!1,this.appCheck=null,this.T=null}start(e,t){const n=e=>{null!=e.error&&Mh("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${e.error.message}`);const n=e.token!==this.T;return this.T=e.token,Mh("FirebaseAppCheckTokenProvider",`Received ${n?"new":"existing"} token.`),n?t(e.token):Promise.resolve()};this.o=t=>{e.enqueueRetryable((()=>n(t)))};const i=e=>{Mh("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=e,this.appCheck.addTokenListener(this.o)};this.I.onInit((e=>i(e))),setTimeout((()=>{if(!this.appCheck){const e=this.I.getImmediate({optional:!0});e?i(e):Mh("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then((e=>e?(Hh("string"==typeof e.token),this.T=e.token,new Yh(e.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Jh(e){const t="undefined"!=typeof self&&(self.crypto||self.msCrypto),n=new Uint8Array(e);if(t&&"function"==typeof t.getRandomValues)t.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(256*Math.random());return n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qh{static A(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=Math.floor(256/e.length)*e.length;let n="";for(;n.length<20;){const i=Jh(40);for(let s=0;s<i.length;++s)n.length<20&&i[s]<t&&(n+=e.charAt(i[s]%e.length))}return n}}function Zh(e,t){return e<t?-1:e>t?1:0}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Il(e){return"__max__"===(((e.mapValue||{}).fields||{}).__type__||{}).stringValue}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const wc="5",Ic=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,bc="ac",Ec="websocket",Tc="long_polling";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hc{constructor(e){this.allowedEvents_=e,this.listeners_={},U(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...t){if(Array.isArray(this.listeners_[e])){const n=[...this.listeners_[e]];for(let e=0;e<n.length;e++)n[e].callback.apply(n[e].context,t)}}on(e,t,n){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:t,context:n});const i=this.getInitialEvent(e);i&&t.apply(n,i)}off(e,t,n){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let e=0;e<i.length;e++)if(i[e].callback===t&&(!n||n===i[e].context))return void i.splice(e,1)}validateEventType_(e){U(this.allowedEvents_.find((t=>t===e)),"Unknown event: "+e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bc=32,Vc=768;class Wc{constructor(e,t){if(void 0===t){this.pieces_=e.split("/");let t=0;for(let e=0;e<this.pieces_.length;e++)this.pieces_[e].length>0&&(this.pieces_[t]=this.pieces_[e],t++);this.pieces_.length=t,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)""!==this.pieces_[t]&&(e+="/"+this.pieces_[t]);return e||"/"}}function zc(){return new Wc("")}function $c(e){return e.pieceNum_>=e.pieces_.length?null:e.pieces_[e.pieceNum_]}function Kc(e){return e.pieces_.length-e.pieceNum_}function Gc(e){let t=e.pieceNum_;return t<e.pieces_.length&&t++,new Wc(e.pieces_,t)}function Yc(e){return e.pieceNum_<e.pieces_.length?e.pieces_[e.pieces_.length-1]:null}function Xc(e,t=0){return e.pieces_.slice(e.pieceNum_+t)}function Jc(e){if(e.pieceNum_>=e.pieces_.length)return null;const t=[];for(let n=e.pieceNum_;n<e.pieces_.length-1;n++)t.push(e.pieces_[n]);return new Wc(t,0)}function Qc(e,t){const n=[];for(let t=e.pieceNum_;t<e.pieces_.length;t++)n.push(e.pieces_[t]);if(t instanceof Wc)for(let e=t.pieceNum_;e<t.pieces_.length;e++)n.push(t.pieces_[e]);else{const e=t.split("/");for(let t=0;t<e.length;t++)e[t].length>0&&n.push(e[t])}return new Wc(n,0)}function Zc(e){return e.pieceNum_>=e.pieces_.length}function eu(e,t){const n=$c(e),i=$c(t);if(null===n)return t;if(n===i)return eu(Gc(e),Gc(t));throw new Error("INTERNAL ERROR: innerPath ("+t+") is not within outerPath ("+e+")")}function tu(e,t){if(Kc(e)!==Kc(t))return!1;for(let n=e.pieceNum_,i=t.pieceNum_;n<=e.pieces_.length;n++,i++)if(e.pieces_[n]!==t.pieces_[i])return!1;return!0}function nu(e,t){let n=e.pieceNum_,i=t.pieceNum_;if(Kc(e)>Kc(t))return!1;for(;n<e.pieces_.length;){if(e.pieces_[n]!==t.pieces_[i])return!1;++n,++i}return!0}class iu{constructor(e,t){this.errorPrefix_=t,this.parts_=Xc(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let e=0;e<this.parts_.length;e++)this.byteLength_+=Ne(this.parts_[e]);su(this)}}function su(e){if(e.byteLength_>Vc)throw new Error(e.errorPrefix_+"has a key path longer than "+Vc+" bytes ("+e.byteLength_+").");if(e.parts_.length>Bc)throw new Error(e.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Bc+") or object contains a cycle "+ru(e))}function ru(e){return 0===e.parts_.length?"":"in property '"+e.parts_.join(".")+"'"}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let vu;mu.EMPTY_NODE=new class{copy(e,t,n,i,s){return this}insert(e,t,n){return new gu(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const wu=function(e){return"number"==typeof e?"number:"+dc(e):"string:"+e},Iu=function(e){if(e.isLeafNode()){const t=e.val();U("string"==typeof t||"number"==typeof t||"object"==typeof t&&fe(t,".sv"),"Priority must be a string or number.")}else U(e===vu||e.isEmpty(),"priority of unexpected type.");U(e===vu||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ju=new class extends cu{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?oc(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return lu.MIN}maxPost(){return lu.MAX}makePost(e,t){const n=Uu(e);return new lu(t,n)}toString(){return".value"}};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hu(e){return{type:"value",snapshotNode:e}}function qu(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function Bu(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Vu(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ku extends jc{constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=Zl("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(U(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=Ku.getListenId_(e,n),o={};this.listens_[r]=o;const a=zu(e._queryParams);this.restRequest_(s+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(s,a,!1,n),ge(this.listens_,r)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=Ku.getListenId_(e,t);delete this.listens_[n]}get(e){const t=zu(e._queryParams),n=e._path.toString(),i=new Q;return this.restRequest_(n+".json",t,((e,t)=>{let s=t;404===e&&(s=null,e=null),null===e?(this.onDataUpdate_(n,s,!1,null),i.resolve(s)):i.reject(new Error(s))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+we(t);this.log_("Sending REST request for "+r);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+r+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=le(o.responseText)}catch(e){nc("Failed to parse JSON response for "+r+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&nc("Got unsuccessful REST response for "+r+" Status: "+o.status),n(o.status);n=null}},o.open("GET",r,!0),o.send()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gu{constructor(){this.rootNode_=Lu.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yu(){return{value:null,children:new Map}}function Xu(e,t,n){if(Zc(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const i=$c(t);e.children.has(i)||e.children.set(i,Yu());Xu(e.children.get(i),t=Gc(t),n)}}function Ju(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{Ju(i,new Wc(t.toString()+"/"+e),n)}))}class Qu{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&uc(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class sd{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=ed.OVERWRITE}operationForChild(e){return Zc(this.path)?new sd(this.source,zc(),this.snap.getImmediateChild(e)):new sd(this.source,Gc(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rd{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=ed.MERGE}operationForChild(e){if(Zc(this.path)){const t=this.children.subtree(new Wc(e));return t.isEmpty()?null:t.value?new sd(this.source,zc(),t.value):new rd(this.source,zc(),t)}return U($c(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new rd(this.source,Gc(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let pd;class fd{constructor(e,t=(()=>(pd||(pd=new mu(ac)),pd))()){this.value=e,this.children=t}static fromObject(e){let t=new fd(null);return uc(e,((e,n)=>{t=t.set(new Wc(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:zc(),value:this.value};if(Zc(e))return null;{const n=$c(e),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue(Gc(e),t);if(null!=s){return{path:Qc(new Wc(n),s.path),value:s.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Zc(e))return this;{const t=$c(e),n=this.children.get(t);return null!==n?n.subtree(Gc(e)):new fd(null)}}set(e,t){if(Zc(e))return new fd(t,this.children);{const n=$c(e),i=(this.children.get(n)||new fd(null)).set(Gc(e),t),s=this.children.insert(n,i);return new fd(this.value,s)}}remove(e){if(Zc(e))return this.children.isEmpty()?new fd(null):new fd(null,this.children);{const t=$c(e),n=this.children.get(t);if(n){const i=n.remove(Gc(e));let s;return s=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&s.isEmpty()?new fd(null):new fd(this.value,s)}return this}}get(e){if(Zc(e))return this.value;{const t=$c(e),n=this.children.get(t);return n?n.get(Gc(e)):null}}setTree(e,t){if(Zc(e))return t;{const n=$c(e),i=(this.children.get(n)||new fd(null)).setTree(Gc(e),t);let s;return s=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new fd(this.value,s)}}fold(e){return this.fold_(zc(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,s)=>{n[i]=s.fold_(Qc(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,zc(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(Zc(e))return null;{const i=$c(e),s=this.children.get(i);return s?s.findOnPath_(Gc(e),Qc(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,zc(),t)}foreachOnPath_(e,t,n){if(Zc(e))return this;{this.value&&n(t,this.value);const i=$c(e),s=this.children.get(i);return s?s.foreachOnPath_(Gc(e),Qc(t,i),n):new fd(null)}}foreach(e){this.foreach_(zc(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(Qc(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hd{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,n=e.childName;U("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),U(".priority"!==n,"Only non-priority child changes can be tracked.");const i=this.changeMap.get(n);if(i){const s=i.type;if("child_added"===t&&"child_removed"===s)this.changeMap.set(n,Vu(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===s)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===s)this.changeMap.set(n,Bu(n,i.oldSnap));else if("child_changed"===t&&"child_added"===s)this.changeMap.set(n,qu(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==s)throw F("Illegal combination of changes: "+e+" occurred after "+i);this.changeMap.set(n,Vu(n,e.snapshotNode,i.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vd(e,t,n,i,s){const r=new Hd;let o,a;if(n.type===ed.OVERWRITE){const h=n;h.source.fromUser?o=$d(e,t,h.path,h.snap,i,s,r):(U(h.source.fromServer,"Unknown source."),a=h.source.tagged||t.serverCache.isFiltered()&&!Zc(h.path),o=zd(e,t,h.path,h.snap,i,s,a,r))}else if(n.type===ed.MERGE){const h=n;h.source.fromUser?o=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,h)=>{const l=Qc(n,i);Kd(t,$c(l))&&(a=$d(e,a,l,h,s,r,o))})),i.foreach(((i,h)=>{const l=Qc(n,i);Kd(t,$c(l))||(a=$d(e,a,l,h,s,r,o))})),a}(e,t,h.path,h.children,i,s,r):(U(h.source.fromServer,"Unknown source."),a=h.source.tagged||t.serverCache.isFiltered(),o=Yd(e,t,h.path,h.children,i,s,a,r))}else if(n.type===ed.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,s,r){let o;if(null!=xd(i,n))return t;{const a=new Bd(i,t,s),h=t.eventCache.getNode();let l;if(Zc(n)||".priority"===$c(n)){let n;if(t.serverCache.isFullyInitialized())n=Pd(i,dd(t));else{const e=t.serverCache.getNode();U(e instanceof Lu,"serverChildren would be complete if leaf node"),n=Dd(i,e)}l=e.filter.updateFullNode(h,n,r)}else{const s=$c(n);let c=Ud(i,s,t.serverCache);null==c&&t.serverCache.isCompleteForChild(s)&&(c=h.getImmediateChild(s)),l=null!=c?e.filter.updateChild(h,s,c,Gc(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(h,s,Lu.EMPTY_NODE,Gc(n),a,r):h,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Pd(i,dd(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=xd(i,zc()),ld(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Hp{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function qp(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||tu(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Bp(e,t,n){qp(e,n),Vp(e,(e=>nu(e,t)||nu(t,e)))}function Vp(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(Wp(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Wp(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Yl&&Ql("event: "+n.toString()),gc(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){jl=wt,mt(new Oe("database",((e,{instanceIdentifier:t})=>If(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),Et(Ul,Fl,e),Et(Ul,Fl,"esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */})),Of.addEventListener("click",(async()=>{var e;await(e=Uf,Ae(e).signOut()),location.reload()})),Cf.addEventListener("click",(()=>{Ef.classList.add("is-hidden")})),(async()=>{var e,t,n;e=e=>{e?(Lf.innerHTML="",Mf.style.display="flex",jf(e),setTimeout((()=>{Ef.classList.add("is-hidden")}),5e3),null!==e.displayName?xf.textContent=`${e.displayName}`:(xf.textContent=`${e.email}`.slice(0,2).toUpperCase(),xf.style.color="grey")):(Lf.innerHTML="",Lf.insertAdjacentHTML("beforeend",'<p class="auth__false__notify">You\'re not logged in</p>'),Hf(),Mf.style.display="none")},Ae(Uf).onAuthStateChanged(e,t,n)})();const qf=document.querySelector("body"),Bf=document.querySelector(".theme-switch .theme-switch__toggle"),Vf="light-theme",Wf="dark-theme",zf=localStorage.getItem("theme");qf.classList.add(Vf),zf===Wf&&(qf.classList.replace(Vf,Wf),Bf.setAttribute("checked","checked")),Bf.addEventListener("click",(function(){qf.classList.contains(Vf)?(qf.classList.replace(Vf,Wf),localStorage.setItem("theme",qf.getAttribute("class"))):(qf.classList.replace(Wf,Vf),localStorage.setItem("theme",qf.getAttribute("class")))}));const $f=new(0,(h=r("7me8F")).BookAPI);(async()=>{const e=[...await $f.getCategories()].sort(((e,t)=>e.list_name.localeCompare(t.list_name)));d.categoriesEl.innerHTML=`<li class="category is-active" data-id="all-categories">\n  All categories\n </li>\n    ${e.map((e=>`<li class="category" data-id= "${e.list_name}" >\n  ${e.list_name}\n </li>`)).join("")}\n    `;document.querySelectorAll(".category").forEach((e=>{e.addEventListener("click",(e=>{const t=document.querySelector(".category.is-active");t&&t.classList.remove("is-active"),e.target.classList.add("is-active");const n=e.target.dataset.id.trim();"all-categories"===e.target.dataset.id?(console.log("рендерим по всем категориям ",e.target.dataset.id),d.book_card__title.innerHTML='\n         Best Sellers <span class="book-card__filter">Books</span>\n        ',g()):(_(n),console.log("рендерим только категорию  refs.galleryContainer",n,d.galleryContainer))}))}))})(),r("bTcpz");var Kf;Kf=new URL(r("kyEFX").resolve("1dOrv"),import.meta.url).toString();var Gf;Gf=new URL(r("kyEFX").resolve("6S0ag"),import.meta.url).toString();var Yf;Yf=new URL(r("kyEFX").resolve("5xnxV"),import.meta.url).toString();var Xf;Xf=new URL(r("kyEFX").resolve("c6pyQ"),import.meta.url).toString();var Jf;Jf=new URL(r("kyEFX").resolve("hmBXq"),import.meta.url).toString();var Qf;Qf=new URL(r("kyEFX").resolve("a7Dxc"),import.meta.url).toString();var Zf;Zf=new URL(r("kyEFX").resolve("fQ0JQ"),import.meta.url).toString();var eg;eg=new URL(r("kyEFX").resolve("9Nww8"),import.meta.url).toString();var tg;tg=new URL(r("kyEFX").resolve("9QusC"),import.meta.url).toString();var ng;ng=new URL(r("kyEFX").resolve("9LcgG"),import.meta.url).toString();var ig;ig=new URL(r("kyEFX").resolve("fRdSt"),import.meta.url).toString();var sg;sg=new URL(r("kyEFX").resolve("bblaK"),import.meta.url).toString();var rg;rg=new URL(r("kyEFX").resolve("ajSwI"),import.meta.url).toString();var og;og=new URL(r("kyEFX").resolve("90MaA"),import.meta.url).toString();var ag;ag=new URL(r("kyEFX").resolve("3wbfv"),import.meta.url).toString();var hg;hg=new URL(r("kyEFX").resolve("c4rxq"),import.meta.url).toString();var lg;lg=new URL(r("kyEFX").resolve("49ZoZ"),import.meta.url).toString();var cg;cg=new URL(r("kyEFX").resolve("kvPik"),import.meta.url).toString();const ug=[{title:"Save the Children",url:"https://www.savethechildren.net/what-we-do/emergencies/ukraine-crisis",img1x:n(ig),img2x:n(sg)},{title:"Project HOPE",url:"https://www.projecthope.org/country/ukraine/",img1x:n(Zf),img2x:n(eg)},{title:"UNITED24",url:"https://u24.gov.ua/uk",img1x:n(ag),img2x:n(hg)},{title:"International Medical Corps",url:"https://internationalmedicalcorps.org/country/ukraine/",img1x:n(Yf),img2x:n(Xf)},{title:"Medicins Sans Frontieres",url:"https://www.msf.org/ukraine",img1x:n(Jf),img2x:n(Qf)},{title:"RAZOM",url:"https://www.razomforukraine.org/",img1x:n(tg),img2x:n(ng)},{title:"Action against hunger",url:"https://www.actionagainsthunger.org/location/europe/ukraine/",img1x:n(Kf),img2x:n(Gf)},{title:"World vision",url:"https://www.wvi.org/emergencies/ukraine",img1x:n(lg),img2x:n(cg)},{title:"Serhiy Prytula Charity Foundation",url:"https://prytulafoundation.org/en",img1x:n(rg),img2x:n(og)}],dg=document.querySelector(".js_support_list"),pg=e=>{const t=e.map(((e,t)=>{const{title:n,url:i,img1x:s,img2x:r}=e;return`\n           <li class="support__item">\n              \n              <a\n                target="_blank"\n                rel="noopener noreferrer"\n                aria-label="company icon"\n                class="support__link"\n                href="${i}"\n              >\n              <p class="support__number">${(t+1).toString().padStart(2,"0")}</p>\n                <img\n                  src="/src/images/support-images/save@1x.png"\n                  alt="${n}"\n                  class="support__img"\n                  srcset="\n                  ${s} 1x,\n                  ${r} 2x\n                  "\n                />\n              </a>\n              `})).join("");dg.innerHTML=`${t}`};pg(ug);const fg=document.querySelectorAll(".support__item"),gg=document.querySelector(".support__btn");let mg=0,_g=!1;gg.addEventListener("click",(function(){_g?(mg-=2,mg<0&&(mg=0,_g=!1,gg.querySelector(".support__icon").style.transform="")):(mg+=2,mg>=fg.length&&(mg=fg.length-1,_g=!0,gg.querySelector(".support__icon").style.transform="rotate(180deg)")),fg.forEach((function(e){e.style.transform=translateY("-${counter * 100}%")}))}));const yg=document.querySelector(".back_to_top");window.addEventListener("scroll",(function(){const e=window.pageYOffset,t=document.documentElement.clientHeight;e>t&&yg.classList.add("back_to_top-show");e<t&&yg.classList.remove("back_to_top-show")})),yg.addEventListener("click",(function(){window.scrollTo({top:0,behavior:"smooth"})}));
//# sourceMappingURL=index.d7f6b4a2.js.map
