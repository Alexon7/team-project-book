 ...
 * limitations under the License.
 */
const vt="firebase-heartbeat-database",It=1,wt="firebase-heartbeat-store";let bt=null;function Et(){return bt||(bt=Je(vt,It,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(wt)}}).catch((e=>{throw pt.create("idb-open",{originalErrorMessage:e.message})}))),bt}async function Tt(e,t){try{const n=(await Et()).transaction(wt,"readwrite"),i=n.objectStore(wt);return await i.put(t,Ct(e)),n.done}catch(e){if(e instanceof te)rt.warn(e.message);else{const t=pt.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});rt.warn(t.message)}}}function Ct(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Mn(e,t=[]){let n;switch(e){case"Browser":n=Tn(K());break;case"Worker":n=`${Tn(K())}-${e}`;break;default:n=e}const i=t.length?t.join(","):"FirebaseCore-web";return`${n}/JsCore/${gt}/${i}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */wi.receivers=[];class Ei{constructor(e){this.target=e,this.handlers=new Set}removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,t,n=50){const i="undefined"!=typeof MessageChannel?new MessageChannel:null;if(!i)throw new Error("connection_unavailable");let s,r;return new Promise(((o,a)=>{const h=bi("",20);i.port1.start();const l=setTimeout((()=>{a(new Error("unsupported_event"))}),n);r={messageChannel:i,onMessage(e){const t=e;if(t.data.eventId===h)switch(t.data.status){case"ack":clearTimeout(l),s=setTimeout((()=>{a(new Error("timeout"))}),3e3);break;case"done":clearTimeout(s),o(t.data.response);break;default:clearTimeout(l),clearTimeout(s),a(new Error("invalid_response"))}}},this.handlers.add(r),i.port1.addEventListener("message",r.onMessage),this.target.postMessage({eventType:e,eventId:h,data:t},[i.port2])})).finally((()=>{r&&this.removeMessageHandler(r)}))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ci(){return void 0!==Ti().WorkerGlobalScope&&"function"==typeof Ti().importScripts}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ls=new Jt(3e4,6e4);function cs(){const e=Ti().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let us=null;function ds(e){return us=us||function(e){return new Promise(((t,n)=>{var i,s,r;function o(){cs(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{cs(),n(jt(e,"network-request-failed"))},timeout:ls.get()})}if(null===(s=null===(i=Ti().gapi)||void 0===i?void 0:i.iframes)||void 0===s?void 0:s.Iframe)t(gapi.iframes.getContext());else{if(!(null===(r=Ti().gapi)||void 0===r?void 0:r.load)){const t=Ui("iframefcb");return Ti()[t]=()=>{gapi.load?o():n(jt(e,"network-request-failed"))},xi(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw us=null,e}))}(e),us}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
class El{constructor(e,t,n,i,s){this.asyncQueue=e,this.timerId=t,this.targetTimeMs=n,this.op=i,this.removalCallback=s,this.deferred=new Fh,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch((e=>{}))}static createAndSchedule(e,t,n,i,s){const r=Date.now()+n,o=new El(e,t,r,i,s);return o.start(n),o}start(e){this.timerHandle=setTimeout((()=>this.handleDelayElapsed()),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){null!==this.timerHandle&&(this.clearTimeout(),this.deferred.reject(new Uh(xh.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget((()=>null!==this.timerHandle?(this.clearTimeout(),this.op().then((e=>this.deferred.resolve(e)))):Promise.resolve()))}clearTimeout(){null!==this.timerHandle&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function Tl(e,t){if(Ph("AsyncQueue",`${t}: ${e}`),Zh(e))return new Uh(xh.UNAVAILABLE,`${t}: ${e}`);throw e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ec={},Tc={};function Cc(e){const t=e.toString();return Ec[t]||(Ec[t]=new bc),Ec[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eu{constructor(e){var t;this.count=(t=e+1,parseInt(Math.log(t)/bu,10)),this.current_=this.count-1;const n=(i=this.count,parseInt(Array(i+1).join("1"),2));var i;this.bits_=e+1&n}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Tu=function(e,t,n,i){e.sort(t);const s=function(t,i){const r=i-t;let o,a;if(0===r)return null;if(1===r)return o=e[t],a=n?n(o):o,new cu(a,o.node,cu.BLACK,null,null);{const h=parseInt(r/2,10)+t,l=s(t,h),c=s(h+1,i);return o=e[h],a=n?n(o):o,new cu(a,o.node,cu.BLACK,l,c)}},r=function(t){let i=null,r=null,o=e.length;const a=function(t,i){const r=o-t,a=o;o-=t;const l=s(r+1,a),c=e[r],u=n?n(c):c;h(new cu(u,c.node,i,null,l))},h=function(e){i?(i.left=e,i=e):(r=e,i=e)};for(let e=0;e<t.count;++e){const n=t.nextBitIsOne(),i=Math.pow(2,t.count-(e+1));n?a(i,cu.BLACK):(a(i,cu.BLACK),a(i,cu.RED))}return r}(new Eu(e.length));return new uu(i||t,r)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Cu;const ku={};class Su{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return P(ku&&wu,"ChildrenNode.ts has not been loaded"),Cu=Cu||new Su({".priority":ku},{".priority":wu}),Cu}get(e){const t=ce(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof uu?t:null}hasIndex(e){return le(this.indexSet_,e.toString())}addIndex(e,t){P(e!==hu,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const s=t.getIterator(su.Wrap);let r,o=s.getNext();for(;o;)i=i||e.isDefinedOn(o.node),n.push(o),o=s.getNext();r=i?Tu(n,e.getCompare()):ku;const a=e.toString(),h=Object.assign({},this.indexSet_);h[a]=e;const l=Object.assign({},this.indexes_);return l[a]=r,new Su(l,h)}addToIndexes(e,t){const n=de(this.indexes_,((n,i)=>{const s=ce(this.indexSet_,i);if(P(s,"Missing index implementation for "+i),n===ku){if(s.isDefinedOn(e.node)){const n=[],i=t.getIterator(su.Wrap);let r=i.getNext();for(;r;)r.name!==e.name&&n.push(r),r=i.getNext();return n.push(e),Tu(n,s.getCompare())}return ku}{const i=t.get(e.name);let s=n;return i&&(s=s.remove(new su(e.name,i))),s.insert(e,e.node)}}));return new Su(n,this.indexSet_)}removeFromIndexes(e,t){const n=de(this.indexes_,(n=>{if(n===ku)return n;{const i=t.get(e.name);return i?n.remove(new su(e.name,i)):n}}));return new Su(n,this.indexSet_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vu extends Lc{constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=Kl("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(P(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=Vu.getListenId_(e,n),o={};this.listens_[r]=o;const a=qu(e._queryParams);this.restRequest_(s+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(s,a,!1,n),ce(this.listens_,r)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=Vu.getListenId_(e,t);delete this.listens_[n]}get(e){const t=qu(e._queryParams),n=e._path.toString(),i=new G;return this.restRequest_(n+".json",t,((e,t)=>{let s=t;404===e&&(s=null,e=null),null===e?(this.onDataUpdate_(n,s,!1,null),i.resolve(s)):i.reject(new Error(s))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+ge(t);this.log_("Sending REST request for "+r);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+r+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=se(o.responseText)}catch(e){Jl("Failed to parse JSON response for "+r+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&Jl("Got unsuccessful REST response for "+r+" Status: "+o.status),n(o.status);n=null}},o.open("GET",r,!0),o.send()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Zu{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Yu.OVERWRITE}operationForChild(e){return Kc(this.path)?new Zu(this.source,qc(),this.snap.getImmediateChild(e)):new Zu(this.source,Bc(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ed{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Yu.MERGE}operationForChild(e){if(Kc(this.path)){const t=this.children.subtree(new jc(e));return t.isEmpty()?null:t.value?new Zu(this.source,qc(),t.value):new ed(this.source,qc(),t)}return P(Hc(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ed(this.source,Bc(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let hd;class ld{constructor(e,t=(()=>(hd||(hd=new uu(nc)),hd))()){this.value=e,this.children=t}static fromObject(e){let t=new ld(null);return oc(e,((e,n)=>{t=t.set(new jc(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:qc(),value:this.value};if(Kc(e))return null;{const n=Hc(e),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue(Bc(e),t);if(null!=s){return{path:Gc(new jc(n),s.path),value:s.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Kc(e))return this;{const t=Hc(e),n=this.children.get(t);return null!==n?n.subtree(Bc(e)):new ld(null)}}set(e,t){if(Kc(e))return new ld(t,this.children);{const n=Hc(e),i=(this.children.get(n)||new ld(null)).set(Bc(e),t),s=this.children.insert(n,i);return new ld(this.value,s)}}remove(e){if(Kc(e))return this.children.isEmpty()?new ld(null):new ld(null,this.children);{const t=Hc(e),n=this.children.get(t);if(n){const i=n.remove(Bc(e));let s;return s=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&s.isEmpty()?new ld(null):new ld(this.value,s)}return this}}get(e){if(Kc(e))return this.value;{const t=Hc(e),n=this.children.get(t);return n?n.get(Bc(e)):null}}setTree(e,t){if(Kc(e))return t;{const n=Hc(e),i=(this.children.get(n)||new ld(null)).setTree(Bc(e),t);let s;return s=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new ld(this.value,s)}}fold(e){return this.fold_(qc(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,s)=>{n[i]=s.fold_(Gc(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,qc(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(Kc(e))return null;{const i=Hc(e),s=this.children.get(i);return s?s.findOnPath_(Bc(e),Gc(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,qc(),t)}foreachOnPath_(e,t,n){if(Kc(e))return this;{this.value&&n(t,this.value);const i=Hc(e),s=this.children.get(i);return s?s.foreachOnPath_(Bc(e),Gc(t,i),n):new ld(null)}}foreach(e){this.foreach_(qc(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(Gc(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
//# sourceMappingURL=index.df3aa7bf.js.map
