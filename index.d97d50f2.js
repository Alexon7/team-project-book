 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class B extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const z=function(e){const t=H(e);return j.encodeByteArray(t,!0)},V=function(e){return z(e).replace(/\./g,"")},q=function(e){try{return j.decodeString(e,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class at{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const lt="@firebase/app",ct="0.9.7",ht=new ze("@firebase/app"),ut="[DEFAULT]",dt={[lt]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},pt=new Map,ft=new Map;function gt(e,t){try{e.container.addComponent(t)}catch(n){ht.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function mt(e){const t=e.name;if(ft.has(t))return ht.debug(`There were multiple attempts to register component ${t}.`),!1;ft.set(t,e);for(const t of pt.values())gt(t,e);return!0}function _t(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const It="firebase-heartbeat-database",St=1,Ct="firebase-heartbeat-store";let kt=null;function Nt(){return kt||(kt=nt(It,St,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(Ct)}}).catch((e=>{throw vt.create("idb-open",{originalErrorMessage:e.message})}))),kt}async function Rt(e,t){try{const n=(await Nt()).transaction(Ct,"readwrite"),i=n.objectStore(Ct);return await i.put(t,At(e)),n.done}catch(e){if(e instanceof oe)ht.warn(e.message);else{const t=vt.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});ht.warn(t.message)}}}function At(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vt(e,...t){throw Gt(e,...t)}function qt(e,...t){return Gt(e,...t)}function Wt(e,t,n){const i=Object.assign(Object.assign({},Ut()),{[t]:n});return new ae("auth","Firebase",i).create(t,{appName:e.name})}function Gt(e,...t){if("string"!=typeof e){const n=t[0],i=[...t.slice(1)];return i[0]&&(i[0].appName=e.name),e._errorFactory.create(n,...i)}return Ht.create(e,...t)}function $t(e,t,...n){if(!e)throw Gt(t,...n)}function Kt(e){const t="INTERNAL ASSERTION FAILED: "+e;throw zt(t),new Error(t)}function Yt(e,t){e||Kt(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mn(e){return 1e3*Number(e)}function _n(e){const[t,n,i]=e.split(".");if(void 0===t||void 0===n||void 0===i)return zt("JWT malformed, contained fewer than 3 sections"),null;try{const e=q(n);return e?JSON.parse(e):(zt("Failed to decode base64 JWT payload"),null)}catch(e){return zt("Caught error parsing JWT payload as JSON",null==e?void 0:e.toString()),null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kn(e,t,n){return`firebase:${e}:${t}:${n}`}class Nn{constructor(e,t,n){this.persistence=e,this.auth=t,this.userKey=n;const{config:i,name:s}=this.auth;this.fullUserKey=kn(this.userKey,i.apiKey,s),this.fullPersistenceKey=kn("persistence",i.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?In._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();return await this.removeCurrentUser(),this.persistence=e,t?this.setCurrentUser(t):void 0}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,n="authUser"){if(!t.length)return new Nn(Jt(Cn),e,n);const i=(await Promise.all(t.map((async e=>{if(await e._isAvailable())return e})))).filter((e=>e));let s=i[0]||Jt(Cn);const r=kn(n,e.config.apiKey,e.name);let o=null;for(const n of t)try{const t=await n._get(r);if(t){const i=In._fromJSON(e,t);n!==s&&(o=i),s=n;break}}catch(e){}const a=i.filter((e=>e._shouldAllowMigration));return s._shouldAllowMigration&&a.length?(s=a[0],o&&await s._set(r,o.toJSON()),await Promise.all(t.map((async e=>{if(e!==s)try{await e._remove(r)}catch(e){}}))),new Nn(s,e,n)):new Nn(s,e,n)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rn(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Ln(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(An(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(xn(t))return"Blackberry";if(Mn(t))return"Webos";if(Pn(t))return"Safari";if((t.includes("chrome/")||On(t))&&!t.includes("edge/"))return"Chrome";if(Dn(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function An(e=Z()){return/firefox\//i.test(e)}function Pn(e=Z()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function On(e=Z()){return/crios\//i.test(e)}function Ln(e=Z()){return/iemobile/i.test(e)}function Dn(e=Z()){return/android/i.test(e)}function xn(e=Z()){return/blackberry/i.test(e)}function Mn(e=Z()){return/webos/i.test(e)}function Fn(e=Z()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Un(){return ie()&&10===document.documentMode}function Hn(e=Z()){return Fn(e)||Dn(e)||Mn(e)||xn(e)||/windows phone/i.test(e)||Ln(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function jn(e,t=[]){let n;switch(e){case"Browser":n=Rn(Z());break;case"Worker":n=`${Rn(Z())}-${e}`;break;default:n=e}const i=t.length?t.join(","):"FirebaseCore-web";return`${n}/JsCore/${wt}/${i}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
var s,r;i.setAttribute("src",e),i.onload=t,i.onerror=e=>{const t=qt("internal-error");t.customData=e,n(t)},i.type="text/javascript",i.charset="UTF-8",(null!==(r=null===(s=document.getElementsByTagName("head"))||void 0===s?void 0:s[0])&&void 0!==r?r:document).appendChild(i)}))}function zi(e){return`__${e}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fs=new nn(3e4,6e4);function gs(){const e=Ri().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let ms=null;function _s(e){return ms=ms||function(e){return new Promise(((t,n)=>{var i,s,r;function o(){gs(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{gs(),n(qt(e,"network-request-failed"))},timeout:fs.get()})}if(null===(s=null===(i=Ri().gapi)||void 0===i?void 0:i.iframes)||void 0===s?void 0:s.Iframe)t(gapi.iframes.getContext());else{if(!(null===(r=Ri().gapi)||void 0===r?void 0:r.load)){const t=zi("iframefcb");return Ri()[t]=()=>{gapi.load?o():n(qt(e,"network-request-failed"))},Bi(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw ms=null,e}))}(e),ms}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xl=new ze("@firebase/firestore");function Ml(e,...t){if(xl.logLevel<=Me.DEBUG){const n=t.map(Ul);xl.debug(`Firestore (${Dl}): ${e}`,...n)}}function Fl(e,...t){if(xl.logLevel<=Me.ERROR){const n=t.map(Ul);xl.error(`Firestore (${Dl}): ${e}`,...n)}}function Ul(e){if("string"==typeof e)return e;try{return t=e,JSON.stringify(t)}catch(t){return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hl(e="Unexpected state"){const t=`FIRESTORE (${Dl}) INTERNAL ASSERTION FAILED: `+e;throw Fl(t),new Error(t)}function jl(e,t){e||Hl()}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Nc{constructor(e,t,n,i,s){this.asyncQueue=e,this.timerId=t,this.targetTimeMs=n,this.op=i,this.removalCallback=s,this.deferred=new Vl,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch((e=>{}))}static createAndSchedule(e,t,n,i,s){const r=Date.now()+n,o=new Nc(e,t,r,i,s);return o.start(n),o}start(e){this.timerHandle=setTimeout((()=>this.handleDelayElapsed()),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){null!==this.timerHandle&&(this.clearTimeout(),this.deferred.reject(new zl(Bl.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget((()=>null!==this.timerHandle?(this.clearTimeout(),this.op().then((e=>this.deferred.resolve(e)))):Promise.resolve()))}clearTimeout(){null!==this.timerHandle&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function Rc(e,t){if(Fl("AsyncQueue",`${t}: ${e}`),sc(e))return new zl(Bl.UNAVAILABLE,`${t}: ${e}`);throw e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Oc{constructor(e){var t;if(void 0===e.host){if(void 0!==e.ssl)throw new zl(Bl.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=e.host,this.ssl=null===(t=e.ssl)||void 0===t||t;if(this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.cache=e.localCache,void 0===e.cacheSizeBytes)this.cacheSizeBytes=41943040;else{if(-1!==e.cacheSizeBytes&&e.cacheSizeBytes<1048576)throw new zl(Bl.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.useFetchStreams=!!e.useFetchStreams,function(e,t,n,i){if(!0===t&&!0===i)throw new zl(Bl.INVALID_ARGUMENT,`${e} and ${n} cannot be used together.`)}("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling)}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bc{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){null==t?delete this.cache_[e]:this.cache_[e]=t}get(e){return fe(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nh={},Rh={};function Ah(e){const t=e.toString();return Nh[t]||(Nh[t]=new kh),Nh[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hh{put(e,t,n,i){}merge(e,t,n,i){}refreshAuthToken(e){}refreshAppCheckToken(e){}onDisconnectPut(e,t,n){}onDisconnectMerge(e,t,n){}onDisconnectCancel(e,t){}reportStats(e){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jh{constructor(e){this.allowedEvents_=e,this.listeners_={},F(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...t){if(Array.isArray(this.listeners_[e])){const n=[...this.listeners_[e]];for(let e=0;e<n.length;e++)n[e].callback.apply(n[e].context,t)}}on(e,t,n){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:t,context:n});const i=this.getInitialEvent(e);i&&t.apply(n,i)}off(e,t,n){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let e=0;e<i.length;e++)if(i[e].callback===t&&(!n||n===i[e].context))return void i.splice(e,1)}validateEventType_(e){F(this.allowedEvents_.find((t=>t===e)),"Unknown event: "+e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bh extends jh{constructor(){super(["online"]),this.online_=!0,"undefined"==typeof window||void 0===window.addEventListener||ee()||(window.addEventListener("online",(()=>{this.online_||(this.online_=!0,this.trigger("online",!0))}),!1),window.addEventListener("offline",(()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))}),!1))}static getInstance(){return new Bh}getInitialEvent(e){return F("online"===e,"Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Au;const Pu={};class Ou{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return F(Pu&&Cu,"ChildrenNode.ts has not been loaded"),Au=Au||new Ou({".priority":Pu},{".priority":Cu}),Au}get(e){const t=ge(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof mu?t:null}hasIndex(e){return fe(this.indexSet_,e.toString())}addIndex(e,t){F(e!==pu,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const s=t.getIterator(cu.Wrap);let r,o=s.getNext();for(;o;)i=i||e.isDefinedOn(o.node),n.push(o),o=s.getNext();r=i?Ru(n,e.getCompare()):Pu;const a=e.toString(),l=Object.assign({},this.indexSet_);l[a]=e;const c=Object.assign({},this.indexes_);return c[a]=r,new Ou(c,l)}addToIndexes(e,t){const n=_e(this.indexes_,((n,i)=>{const s=ge(this.indexSet_,i);if(F(s,"Missing index implementation for "+i),n===Pu){if(s.isDefinedOn(e.node)){const n=[],i=t.getIterator(cu.Wrap);let r=i.getNext();for(;r;)r.name!==e.name&&n.push(r),r=i.getNext();return n.push(e),Ru(n,s.getCompare())}return Pu}{const i=t.get(e.name);let s=n;return i&&(s=s.remove(new cu(e.name,i))),s.insert(e,e.node)}}));return new Ou(n,this.indexSet_)}removeFromIndexes(e,t){const n=_e(this.indexes_,(n=>{if(n===Pu)return n;{const i=t.get(e.name);return i?n.remove(new cu(e.name,i)):n}}));return new Ou(n,this.indexSet_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hu=new class extends hu{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?oh(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return cu.MIN}maxPost(){return cu.MAX}makePost(e,t){const n=Fu(e);return new cu(t,n)}toString(){return".value"}};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ju(e){return{type:"value",snapshotNode:e}}function Bu(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function zu(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Vu(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $u extends Hh{constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=Zc("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(F(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=$u.getListenId_(e,n),o={};this.listens_[r]=o;const a=Wu(e._queryParams);this.restRequest_(s+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(s,a,!1,n),ge(this.listens_,r)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=$u.getListenId_(e,t);delete this.listens_[n]}get(e){const t=Wu(e._queryParams),n=e._path.toString(),i=new Q;return this.restRequest_(n+".json",t,((e,t)=>{let s=t;404===e&&(s=null,e=null),null===e?(this.onDataUpdate_(n,s,!1,null),i.resolve(s)):i.reject(new Error(s))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+we(t);this.log_("Sending REST request for "+r);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+r+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=ce(o.responseText)}catch(e){nh("Failed to parse JSON response for "+r+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&nh("Got unsuccessful REST response for "+r+" Status: "+o.status),n(o.status);n=null}},o.open("GET",r,!0),o.send()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jd{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,n=e.childName;F("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),F(".priority"!==n,"Only non-priority child changes can be tracked.");const i=this.changeMap.get(n);if(i){const s=i.type;if("child_added"===t&&"child_removed"===s)this.changeMap.set(n,Vu(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===s)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===s)this.changeMap.set(n,zu(n,i.oldSnap));else if("child_changed"===t&&"child_added"===s)this.changeMap.set(n,Bu(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==s)throw U("Illegal combination of changes: "+e+" occurred after "+i);this.changeMap.set(n,Vu(n,e.snapshotNode,i.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vd(e,t,n,i,s){const r=new jd;let o,a;if(n.type===ed.OVERWRITE){const l=n;l.source.fromUser?o=Gd(e,t,l.path,l.snap,i,s,r):(F(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!Zh(l.path),o=Wd(e,t,l.path,l.snap,i,s,a,r))}else if(n.type===ed.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,l)=>{const c=Qh(n,i);$d(t,Gh(c))&&(a=Gd(e,a,c,l,s,r,o))})),i.foreach(((i,l)=>{const c=Qh(n,i);$d(t,Gh(c))||(a=Gd(e,a,c,l,s,r,o))})),a}(e,t,l.path,l.children,i,s,r):(F(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=Yd(e,t,l.path,l.children,i,s,a,r))}else if(n.type===ed.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,s,r){let o;if(null!=xd(i,n))return t;{const a=new zd(i,t,s),l=t.eventCache.getNode();let c;if(Zh(n)||".priority"===Gh(n)){let n;if(t.serverCache.isFullyInitialized())n=Od(i,dd(t));else{const e=t.serverCache.getNode();F(e instanceof Du,"serverChildren would be complete if leaf node"),n=Ld(i,e)}c=e.filter.updateFullNode(l,n,r)}else{const s=Gh(n);let h=Fd(i,s,t.serverCache);null==h&&t.serverCache.isCompleteForChild(s)&&(h=l.getImmediateChild(s)),c=null!=h?e.filter.updateChild(l,s,h,Kh(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(l,s,Du.EMPTY_NODE,Kh(n),a,r):l,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Od(i,dd(t)),o.isLeafNode()&&(c=e.filter.updateFullNode(c,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=xd(i,Wh()),cd(t,c,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class jp{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Bp(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||tu(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function zp(e,t,n){Bp(e,n),Vp(e,(e=>nu(e,t)||nu(t,e)))}function Vp(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(qp(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function qp(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Yc&&Qc("event: "+n.toString()),gh(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Hc=wt,mt(new Pe("database",((e,{instanceIdentifier:t})=>bf(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),Et(Fc,Uc,e),Et(Fc,Uc,"esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const Ef=document.querySelector(".auth__backdrop"),If=document.querySelector(".auth__form"),Sf=(document.querySelector(".auth__unputs"),document.querySelector(".auth__button__close")),Cf=document.querySelector("#user_name"),kf=document.querySelector("#user_email"),Nf=document.querySelector("#user_password"),Rf=document.querySelector("#btnLogin"),Af=document.querySelector("#btnSignup"),Pf=document.querySelector("#btnLogout"),Of=document.querySelector(".link__signup"),Lf=document.querySelector(".link__signin"),Df=document.querySelector(".message__login"),xf=document.querySelector(".users-login"),Mf=document.querySelector(".users-data--tablet").lastElementChild;console.log(xf.textContent);const Ff=function(e=Tt()){const t=_t(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=_t(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(ve(n.getOptions(),null!=t?t:{}))return e;Vt(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Ps,persistence:[ji,Ei,Si]}),i=J("authTokenSyncURL");if(i){const e=(s=i,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>xs)return;const i=null==t?void 0:t.token;Ms!==i&&(Ms=i,await fetch(s,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){Ae(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,i){Ae(e).onIdTokenChanged(t,n,i)}(n,(t=>e(t)))}var s;const r=Y("auth");return r&&Wn(n,`http://${r}`),n}(bt({appName:"BookProject",apiKey:"AIzaSyCeohKwpW6233js3UPE5dhzJtQnOMgZfaI",authDomain:"itsharks-books-project.firebaseapp.com",databaseURL:"https://itsharks-books-project-default-rtdb.firebaseio.com",projectId:"itsharks-books-project",storageBucket:"itsharks-books-project.appspot.com",messagingSenderId:"560994919300",appId:"1:560994919300:web:10cdf4110616a9d01f33d1"}));const Uf=e=>{e.code==jt.INVALID_PASSWORD?alert("Wrong password. Try again."):alert(`Error: ${e.message}`)},Hf=e=>{Df.insertAdjacentHTML("beforeend",`<p class="auth__true__notify">You're logged in as <span>${e.email}<span></p>`),If.style.display="none",Pf.style.display="block"};Lf.addEventListener("click",(()=>{Rf.style.display="",Af.style.display="none",Of.style.display="",Lf.style.display="none",Cf.style.display="none",Df.innerHTML="",Df.insertAdjacentHTML("beforeend",'<p class="auth__false__notify">You\'re not logged in</p>')})),Of.addEventListener("click",(()=>{Rf.remove(),Af.style.display="block",Of.style.display="none",Lf.style.display="block",Cf.style.display="block",Df.innerHTML="",Df.insertAdjacentHTML("beforeend",'<p class="auth__notify">You can SIGN UP on this website</p>')}));Af.addEventListener("click",(async e=>{e.preventDefault();const t=Cf.value.trim(),n=kf.value.trim(),i=Nf.value.trim();Cf.style.display="block";try{await vi(Ff,n,i).then((()=>{yi(Ff.currentUser,{displayName:t})})),location.reload()}catch{}}));const jf=()=>{If.style.display="block",Pf.style.display="none",Cf.style.display="none",kf.value="",Nf.value=""};Rf.addEventListener("click",(async e=>{e.preventDefault();const t=kf.value.trim(),n=Nf.value.trim();console.log(t);try{await(i=Ff,s=t,r=n,_i(Ae(i),ni.credential(s,r)))}catch(e){console.log(`There was an error: ${e}`),Uf(e)}var i,s,r;
/**
 * @license
 * Copyright 2020 Google LLC
 *
