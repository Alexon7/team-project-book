 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bu extends Lc{constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=Gl("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(P(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=Bu.getListenId_(e,n),o={};this.listens_[r]=o;const a=qu(e._queryParams);this.restRequest_(s+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(s,a,!1,n),ce(this.listens_,r)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=Bu.getListenId_(e,t);delete this.listens_[n]}get(e){const t=qu(e._queryParams),n=e._path.toString(),i=new K;return this.restRequest_(n+".json",t,((e,t)=>{let s=t;404===e&&(s=null,e=null),null===e?(this.onDataUpdate_(n,s,!1,null),i.resolve(s)):i.reject(new Error(s))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+ge(t);this.log_("Sending REST request for "+r);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+r+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=se(o.responseText)}catch(e){Jl("Failed to parse JSON response for "+r+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&Jl("Got unsuccessful REST response for "+r+" Status: "+o.status),n(o.status);n=null}},o.open("GET",r,!0),o.send()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Zu{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Yu.OVERWRITE}operationForChild(e){return Gc(this.path)?new Zu(this.source,qc(),this.snap.getImmediateChild(e)):new Zu(this.source,Vc(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ed{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Yu.MERGE}operationForChild(e){if(Gc(this.path)){const t=this.children.subtree(new jc(e));return t.isEmpty()?null:t.value?new Zu(this.source,qc(),t.value):new ed(this.source,qc(),t)}return P(Hc(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ed(this.source,Vc(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let hd;class ld{constructor(e,t=(()=>(hd||(hd=new uu(nc)),hd))()){this.value=e,this.children=t}static fromObject(e){let t=new ld(null);return oc(e,((e,n)=>{t=t.set(new jc(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:qc(),value:this.value};if(Gc(e))return null;{const n=Hc(e),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue(Vc(e),t);if(null!=s){return{path:Kc(new jc(n),s.path),value:s.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Gc(e))return this;{const t=Hc(e),n=this.children.get(t);return null!==n?n.subtree(Vc(e)):new ld(null)}}set(e,t){if(Gc(e))return new ld(t,this.children);{const n=Hc(e),i=(this.children.get(n)||new ld(null)).set(Vc(e),t),s=this.children.insert(n,i);return new ld(this.value,s)}}remove(e){if(Gc(e))return this.children.isEmpty()?new ld(null):new ld(null,this.children);{const t=Hc(e),n=this.children.get(t);if(n){const i=n.remove(Vc(e));let s;return s=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&s.isEmpty()?new ld(null):new ld(this.value,s)}return this}}get(e){if(Gc(e))return this.value;{const t=Hc(e),n=this.children.get(t);return n?n.get(Vc(e)):null}}setTree(e,t){if(Gc(e))return t;{const n=Hc(e),i=(this.children.get(n)||new ld(null)).setTree(Vc(e),t);let s;return s=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new ld(this.value,s)}}fold(e){return this.fold_(qc(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,s)=>{n[i]=s.fold_(Kc(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,qc(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(Gc(e))return null;{const i=Hc(e),s=this.children.get(i);return s?s.findOnPath_(Vc(e),Kc(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,qc(),t)}foreachOnPath_(e,t,n){if(Gc(e))return this;{this.value&&n(t,this.value);const i=Hc(e),s=this.children.get(i);return s?s.foreachOnPath_(Vc(e),Kc(t,i),n):new ld(null)}}foreach(e){this.foreach_(qc(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(Kc(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
