 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qt=new k(5e3,15e3),Wt="__/auth/iframe",Gt="emulator/auth/iframe",$t={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Yt=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Kt(e){const t=e.config;y(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?x(t,Gt):`https://${e.config.authDomain}/${Wt}`,s={apiKey:t.apiKey,appName:e.name,v:r.SDK_VERSION},o=Yt.get(e.config.apiHost);o&&(s.eid=o);const a=e._getFrameworks();return a.length&&(s.fw=a.join(",")),`${n}?${(0,i.querystring)(s).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const W="5",G=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,$="ac",Y="websocket",K="long_polling";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht{constructor(e){this.writeTree_=e}static empty(){return new Ht(new jt(null))}}function zt(e,t,n){if(Ie(t))return new Ht(new jt(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const r=i.path;let s=i.value;const o=Se(r,t);return s=s.updateChild(o,n),new Ht(e.writeTree_.set(r,s))}{const i=new jt(n),r=e.writeTree_.setTree(t,i);return new Ht(r)}}}function Vt(e,t,n){let i=e;return M(n,((e,n)=>{i=zt(i,be(t,e),n)})),i}function Bt(e,t){if(Ie(t))return Ht.empty();{const n=e.writeTree_.setTree(t,new jt(null));return new Ht(n)}}function qt(e,t){return null!=Wt(e,t)}function Wt(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Se(n.path,t)):null}function Gt(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Je,((e,n)=>{t.push(new Le(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Le(e,n.value))})),t}function $t(e,t){if(Ie(t))return e;{const n=Wt(e,t);return new Ht(null!=n?new jt(n):e.writeTree_.subtree(t))}}function Yt(e){return e.writeTree_.isEmpty()}function Kt(e,t){return Xt(me(),e.writeTree_,t)}function Xt(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,s)=>{".priority"===t?((0,r.assert)(null!==s.value,"Priority writes must always be leaf nodes"),i=s.value):n=Xt(be(e,t),s,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(be(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Bi="FIREBASE_DATABASE_EMULATOR_HOST",qi={};let Wi=!1;function Gi(e,t,n,i,r){let s=i||e.options.databaseURL;void 0===s&&(e.options.projectId||C("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),b("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,l,c=Ui(s,r),u=c.repoInfo;void 0!==a&&a.env&&(l=a.env[Bi]),l?(o=!0,s=`http://${l}?ns=${u.namespace}`,c=Ui(s,r),u=c.repoInfo):o=!c.repoInfo.secure;const h=r&&o?new q(q.OWNER):new B(e.name,e.options,t);hi("Invalid Firebase Database URL",c),Ie(c.path)||C("Database URL must point to the root of a Firebase Database (not including a child path).");const d=function(e,t,n,i){let r=qi[t.name];r||(r={},qi[t.name]=r);let s=r[e.toURLString()];s&&C("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new yi(e,Wi,n,i),r[e.toURLString()]=s,s}(u,e,h,new V(e.name,n));return new $i(d,e)}class $i{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(wi(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Vi(this._repo,me())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=qi[t];n&&n[e.key]===e||C(`Database ${t}(${e.repoInfo_}) has already been deleted.`),ki(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&C("Cannot call "+e+" on a deleted database.")}}Oe.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Oe.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};
/**
 * @license
 * Copyright 2021 Google LLC
 *
